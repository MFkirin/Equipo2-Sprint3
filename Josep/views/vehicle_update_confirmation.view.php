<section class="vehicle_update">
    ...
    <form action="/vehicle_update_process.php" method="post" enctype="multipart/form-data" class="form-container">
        ...
        <div class="form-column">
            ...
            <input type="text" id="gearbox" name="gearbox" value="<?= $vehicleToUpdate->getGearbox(); ?>">
