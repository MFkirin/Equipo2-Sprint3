                    ...
                    <section>
                        ...
                        <table id="providerList" class="tablesorter">
                            ...
                            <tr>
                                ...
                                <th><span>Títol de banc</span> <img src="/assets/img/caret-abajo.png" alt="arrow" class="filterArrow"></th>
                                <th><span>NIF del gerent</span> <img src="/assets/img/caret-abajo.png" alt="arrow" class="filterArrow"></th>
                                <th><span>Document LOPD</span> <img src="/assets/img/caret-abajo.png" alt="arrow" class="filterArrow"></th>
                                <th><span> Article de la Constitució</span> <img src="/assets/img/caret-abajo.png" alt="arrow" class="filterArrow"></th>
                            ...
                            <?php foreach ($providers as $provider): ?>
                                <tr>
                                    <td class="show"><span class="mobileTitle">Id: </span><?= $provider->getId() ?></td>
                                    ...
                                    <td class="noshow"><span class="mobileTitle">Títol del banc: </span><?= $provider->getBankTitle()?></td>
                                    <td class="noshow"><span class="mobileTitle">NIF del gerent: </span><?= $provider->getManagerNIF() ?></td>
                                    <td class="noshow"><span class="mobileTitle">Document LOPD: </span><?= $provider->getLOPDdoc() ?></td>
                                    <td class="noshow"><span class="mobileTitle">Article de la constitució: </span><?= $provider->getConstitutionArticle()?></td>
                                    <td class="noshow"><a href="provider_delete.php?id=<?= $provider->getId();?>" class="actions"  id="delProvider" >Esborrar</a></td>
