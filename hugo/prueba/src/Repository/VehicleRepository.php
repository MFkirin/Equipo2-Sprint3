...
class VehicleRepository extends Repository {
    ...
    {
        // Validar que $orderId cumple con los requisitos antes de realizar la consulta
        if ($orderId <= 0) {
            throw new InvalidArgumentException('Order_ID no válido.');
        }
        ...
        try {
            ...
            throw new RuntimeException('Error en la consulta de vehículos por Order_ID.');
        }
    }
}