...
require_once __DIR__ . '/Exception/NoUploadedFileException.php';
require_once __DIR__ . '/Exception/InvalidTypeUploadedFileException.php';
require_once __DIR__ . '/Exception/TooBigUploadedFileException.php';
...
class UploadedFileHandler
{
    ...
    public function handle(string $path): string
    {
        ...
        $newFilename = md5((string)rand()) . "src" . $extension;
